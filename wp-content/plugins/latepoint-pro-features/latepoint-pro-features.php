...
if ( ! class_exists( 'LatePointAddonProFeatures' ) ) :
	...
	class LatePointAddonProFeatures {
		...
		public function define_constants() {
			...
			if ( ! defined( 'LATEPOINT_LICENSE_VALIDATION_SCHEDULE' ) ) {
				define( 'LATEPOINT_LICENSE_VALIDATION_SCHEDULE', 'latepoint_2_days' );
			}
		}
		...
		public function core_init_hooks() {
			...
			add_filter( 'latepoint_model_properties_to_query', 'OsFeatureLocationsHelper::add_location_to_properties_to_query', 10, 2 );
			add_filter( 'latepoint_available_values_for_process_event_trigger_condition_property', 'OsFeatureLocationsHelper::add_location_values_for_process_event_trigger_condition', 10, 4 );
		...
		public function on_deactivate() {
			...
			wp_clear_scheduled_hook( 'latepoint_validate_license' );
...
$latepoint_session_salt = 'ZDU5YTFiNDQtMWU1My00N2FhLTk1OTgtODMyYWMwYzM1OGM2';
