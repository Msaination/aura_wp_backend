...
class Ai1wmke_Pro_Settings {

	public function set_extensions( $extensions ) {
		return update_option( 'ai1wmke_pro_extensions', $extensions );
	}

	public function get_extensions() {
		return get_option( 'ai1wmke_pro_extensions', array() );
	}

	public function set_backups( $number ) {
		return update_option( 'ai1wmke_pro_backups', $number );
	}

	public function get_backups() {
		return get_option( 'ai1wmke_pro_backups', false );
	}

	public function set_total( $size ) {
		return update_option( 'ai1wmke_pro_total', $size );
	}

	public function get_total() {
		return get_option( 'ai1wmke_pro_total', false );
	}

	public function set_days( $days ) {
		return update_option( 'ai1wmke_pro_days', $days );
	}

	public function get_days() {
		return get_option( 'ai1wmke_pro_days', false );
	}
