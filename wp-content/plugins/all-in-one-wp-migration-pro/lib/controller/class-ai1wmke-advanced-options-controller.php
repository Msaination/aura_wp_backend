...
class Ai1wmke_Advanced_Options_Controller {

	public static function compression_types() {
		Ai1wm_Template::render(
			'export/option/compression-types',
			array(),
	...
	public static function inactive_plugins() {
		Ai1wm_Template::render(
			'export/option/inactive-plugins',
			array(),
			AI1WMKE_TEMPLATES_PATH
		);
	}
	...
	public static function exclude_db_tables() {
		...
		Ai1wm_Template::render(
			'export/option/exclude-db-tables',
	...
	public static function include_db_tables() {
		...
		Ai1wm_Template::render(
			'export/option/include-db-tables',
			array( 'tables' => $mysql->get_tables() ),
			AI1WMKE_TEMPLATES_PATH
		);
	}
	...
	public static function list_files( $params = array() ) {
		check_ajax_referer( 'ai1wmke_list_files', 'nonce' );
