...
<script type="text/html" id="schedule-event-template">
	<form method="post" action="<?php echo esc_url( wp_nonce_url( admin_url( 'admin-post.php?action=ai1wmke_schedule_event_save' ), 'ai1wmke_schedule_event_save' ) ); ?>" id="ai1wmke-schedule-event-form" class="ai1wm-clear">
				...
				<div class="ai1wm-event-row" v-if="form.type === '<?php echo Ai1wmke_Schedule_Event::TYPE_EXPORT; ?>'">
					<div class="ai1wm-event-field ai1wm-compression-backups-container">
						<label class="ai1wm-event-label" for="ai1wm-event-compression">
							...
							<?php _e( 'Compress this backup', AI1WMKE_PLUGIN_NAME ); ?>
						</label>
								...
								<?php if ( ai1wm_has_compression_type( 'gzip' ) ) : ?>
									<div class="ai1wm-input-compression-container">
										<label for="ai1wm-compression-type-gzip">
											...
											<?php _e( 'GZip (Fast, good compression)', AI1WMKE_PLUGIN_NAME ); ?>
										</label>
									</div>
								<?php endif; ?>
								...
								<?php if ( ai1wm_has_compression_type( 'bzip2' ) ) : ?>
									<div class="ai1wm-input-compression-container">
										<label for="ai1wm-compression-type-bzip2">
											...
											<?php _e( 'BZip2 (Slower, better compression)', AI1WMKE_PLUGIN_NAME ); ?>
										</label>
									</div>
								<?php endif; ?>
							</div>
		...
		<div class="ai1wm-event-fieldset" style="display: flex; justify-content: flex-end;">
			<button class="ai1wm-button-green" :disabled="!passwordConfirmed"><?php _e( 'Save', AI1WMKE_PLUGIN_NAME ); ?></button>
		</div>
	</form>
</script>
