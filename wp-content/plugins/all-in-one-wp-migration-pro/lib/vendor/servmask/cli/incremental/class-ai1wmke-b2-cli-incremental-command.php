...
class Ai1wmke_B2_CLI_Incremental_Command extends Ai1wmke_B2_CLI_Command {
	...
	/**
	 * Creates a new incremental backup and uploads to Backblaze B2.
	 *
	 * ## OPTIONS
	 *
	 ...
	 * ## EXAMPLES
	 *
	 * $ wp ai1wm b2 incremental backup --replace "wp" "WordPress"
	 * Backup in progress...
