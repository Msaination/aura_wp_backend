...
class Ai1wmke_GCloud_Storage_CLI_Incremental_Command extends Ai1wmke_GCloud_Storage_CLI_Command {
	...
	/**
	 * Creates a new incremental backup and uploads to Google Cloud Storage.
	 *
	 * ## OPTIONS
	 *
	 ...
	 * ## EXAMPLES
	 *
	 * $ wp ai1wm gcloud-storage incremental backup --replace "wp" "WordPress"
	 * Backup in progress...
