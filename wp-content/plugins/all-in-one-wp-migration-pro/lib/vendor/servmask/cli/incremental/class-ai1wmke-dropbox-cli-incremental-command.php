...
class Ai1wmke_Dropbox_CLI_Incremental_Command extends Ai1wmke_Dropbox_CLI_Command {
	...
	/**
	 * Creates a new incremental backup and uploads to Dropbox.
	 *
	 * ## OPTIONS
	 *
	 ...
	 * ## EXAMPLES
	 *
	 * $ wp ai1wm dropbox incremental backup --replace "wp" "WordPress"
	 * Backup in progress...
