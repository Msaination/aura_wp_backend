...
class Ai1wmke_S3_Client_CLI_Incremental_Command extends Ai1wmke_S3_Client_CLI_Command {
	...
	/**
	 * Creates a new incremental backup and uploads to S3-compatible storage.
	 *
	 * ## OPTIONS
	 *
	 ...
	 * ## EXAMPLES
	 *
	 * $ wp ai1wm s3-client incremental backup --replace "wp" "WordPress"
	 * Backup in progress...
