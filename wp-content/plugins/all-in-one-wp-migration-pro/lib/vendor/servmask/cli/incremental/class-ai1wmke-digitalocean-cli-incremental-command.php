...
class Ai1wmke_DigitalOcean_CLI_Incremental_Command extends Ai1wmke_DigitalOcean_CLI_Command {
	 ...
	 * ## EXAMPLES
	 *
	 * $ wp ai1wm digitalocean incremental backup --replace "wp" "WordPress"
	 * Backup in progress...
