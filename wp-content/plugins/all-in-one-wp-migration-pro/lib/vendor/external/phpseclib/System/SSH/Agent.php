 ...
 */
namespace Ai1wmke_Vendor\phpseclib\System\SSH;

use Ai1wmke_Vendor\phpseclib\Crypt\RSA;
use Ai1wmke_Vendor\phpseclib\System\SSH\Agent\Identity;
/**
...
class Agent
{
    ...
    function __construct($address = null)
    {
        ...
        } else if (substr($address, 0, 9) != '\\\\.\pipe\\' || strpos(substr($address, 9), '\\') !== \false) {
