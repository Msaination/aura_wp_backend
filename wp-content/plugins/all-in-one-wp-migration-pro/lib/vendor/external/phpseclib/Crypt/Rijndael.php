...
class Rijndael extends Base
{
    ...
    function &_getTables()
    {
        ...
        if (empty($tables)) {
            ...
            foreach ($t3 as $t3i) {
                $t0[] = $t3i << 24 & $this->safe_intval(0xff000000) | $t3i >> 8 & 0xffffff;
                $t1[] = $t3i << 16 & $this->safe_intval(0xffff0000) | $t3i >> 16 & 0xffff;
                $t2[] = $t3i << 8 & $this->safe_intval(0xffffff00) | $t3i >> 24 & 0xff;
            }
            $tables = array(
