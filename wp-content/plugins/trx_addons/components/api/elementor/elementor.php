...
if ( ! function_exists( 'trx_addons_elm_clear_css_cache' ) ) {
	add_action( str_replace( '-', '_', get_template() ) . "_action_save_options", 'trx_addons_elm_clear_css_cache', 20 );
	/**
	 * Clear a CSS cache for the Elementor documents
	 * 
	 * @hooked {template}_action_save_options
	 */
	function trx_addons_elm_clear_css_cache() {
...
require_once TRX_ADDONS_PLUGIN_DIR . TRX_ADDONS_PLUGIN_API . 'elementor/extensions/menu-anchor.php';
