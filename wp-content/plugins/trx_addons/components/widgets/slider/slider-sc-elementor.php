		...
		class TRX_Addons_Elementor_Widget_Slider extends TRX_Addons_Elementor_Widget {
			...
			protected function register_controls() {
				...
				if ( $this->styles_allowed ) {
					...
					$this->register_style_controls_slide_button();
						...
						'fields' => apply_filters('trx_addons_sc_param_group_params',
							[
								...
								[
									...
									'placeholder' => __( "Slide's Description", 'trx_addons' ),
									'default' => ''
								],
								[
									'name' => 'button_caption',
									...
									'label_block' => false,
									'type' => Controls_Manager::TEXT,
									'description' => __( "Caption of the button below description. If empty - button is not appear.", 'trx_addons' ),
									'default' => ''
								],
								[
									'name' => 'button_link',
								...
								[
									'name' => 'link',
									'label' => __( 'Slide Link', 'trx_addons' ),
									'label_block' => false,
									'type' => Controls_Manager::URL,
									'default' => ['url' => ''],
									'placeholder' => __( '//your-link.com', 'trx_addons' ),
			...
			protected function register_content_controls_layout( $tab ) {
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' => array(
							'{{WRAPPER}} .widget_slider .slider_outer' => 'height: {{SIZE}}{{UNIT}};',
						),
						'condition' => [
							'noresize' => '1'
						],
			...
			protected function register_style_controls_slide() {
				...
				$this->add_responsive_control(
					...
					[
						...
						'size_units' => [ 'px' ],
						'selectors' => [
							'{{WRAPPER}} .slider-slide .slide_overlay' => 'opacity: {{SIZE}};',
						]
					]
				);
			...
			protected function register_style_controls_slide_meta() {
				$this->start_controls_section(
					...
					array(
						'label' => __( 'Slide Description', 'trx_addons' ),
						'tab' => Controls_Manager::TAB_STYLE,
					)
				);
			...
			/**
			 * Register style controls for the block with a slide button.
			 */
			protected function register_style_controls_slide_button() {
				$this->start_controls_section(
					'section_sc_slider_style_info_button',
					array(
						'label' => __( 'Slide Button', 'trx_addons' ),
						'tab' => Controls_Manager::TAB_STYLE,
					)
				);

				$this->start_controls_tabs( 'tabs_info_button_style' );

				$this->start_controls_tab(
					'tab_info_button_normal',
					[
						'label' => __( 'Normal', 'trx_addons' ),
					]
				);
				...
				$this->add_group_control(
					...
					array(
						...
						'selector' => '{{WRAPPER}} .slider-slide .slide_info .slide_button > a',
					)
				);
				...
				$this->add_control(
					...
					array(
						...
						'type'      => Controls_Manager::COLOR,
						'selectors' => array(
							'{{WRAPPER}} .slider-slide .slide_info .slide_button > a' => 'color: {{VALUE}};',
						),
					)
				);
				...
				$this->add_responsive_control(
					...
					array(
						...
						'size_units' => [ 'px', '%', 'em', 'rem', 'vw', 'vh', 'custom' ],
						'selectors'  => array(
							'{{WRAPPER}} .slider-slide .slide_info .slide_button > a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
						),
					)
				);
				...
				$this->add_responsive_control(
					...
					array(
						...
						'size_units' => [ 'px', '%', 'em', 'rem', 'vw', 'vh', 'custom' ],
						'selectors'  => array(
							'{{WRAPPER}} .slider-slide .slide_info .slide_button > a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						),
					)
				);
				...
				$this->add_responsive_control(
					...
					array(
						...
						'size_units' => [ 'px', '%', 'em', 'rem', 'vw', 'vh', 'custom' ],
						'selectors'  => array(
							'{{WRAPPER}} .slider-slide .slide_info .slide_button' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						),
					)
				);
				...
				$this->add_group_control(
					Group_Control_Background::get_type(),
					array(
						'name'     => 'info_button_background_hover',
						'selector' => '{{WRAPPER}} .slider-slide .slide_info .slide_button > a:hover',
					)
				);

				$this->add_control(
					'info_button_color_hover',
					array(
						'label'     => __( 'Color', 'trx_addons' ),
						'type'      => Controls_Manager::COLOR,
						'selectors' => array(
							'{{WRAPPER}} .slider-slide .slide_info .slide_button > a:hover' => 'color: {{VALUE}};',
						),
					)
				);
				...
				$this->add_group_control(
					Group_Control_Text_Shadow::get_type(),
					array(
						'name'     => 'info_button_text_shadow_hover',
						'selector' => '{{WRAPPER}} .slider-slide .slide_info .slide_button > a:hover',
					)
				);
			...
			protected function register_style_controls_pagination() {
				...
				$this->add_responsive_control(
					'pagination_align',
					array(
						'label'        => __( 'Alignment', 'trx-wcext' ),
						'type'         => Controls_Manager::CHOOSE,
						'options'      => array(
							'left'   => array( 'title' => __( 'Left',   'trx-wcext' ), 'icon' => 'eicon-text-align-left'   ),
							'center' => array( 'title' => __( 'Center',   'trx-wcext' ), 'icon' => 'eicon-text-align-center'   ),
							'right'  => array( 'title' => __( 'Right',  'trx-wcext' ), 'icon' => 'eicon-text-align-right'  ),
						),
						'selectors'    => array(
							'{{WRAPPER}} .slider_pagination_wrap' => 'text-align: {{VALUE}};',
						),
						'condition' => [
							'pagination_type' => ['bullets', 'fraction'],
							'pagination_pos' => ['bottom', 'bottom_outside']
						]
					)
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'size_units' => [ 'px', '%', 'em', 'rem', 'vw', 'vh', 'custom' ],
						'selectors' => [
							'{{WRAPPER}} .slider_container.slider_pagination_pos_bottom .slider_pagination_wrap' => 'margin-bottom: {{SIZE}}{{UNIT}};',
							'{{WRAPPER}} .slider_container.slider_pagination_pos_left .slider_pagination_wrap' => 'margin-left: {{SIZE}}{{UNIT}};',
							'{{WRAPPER}} .slider_container.slider_pagination_pos_right .slider_pagination_wrap' => 'margin-right: {{SIZE}}{{UNIT}};',
				...
				$this->add_responsive_control(
					...
					[
						...
						'size_units' => [ 'px', '%', 'em', 'rem', 'vw', 'vh', 'custom' ],
						'selectors' => [
							'{{WRAPPER}} .slider_container .slider_pagination_wrap' => 'padding-left: {{SIZE}}{{UNIT}}; padding-right: {{SIZE}}{{UNIT}};',
							'{{WRAPPER}} .slider_container ~ .slider_pagination_wrap' => 'padding-left: {{SIZE}}{{UNIT}}; padding-right: {{SIZE}}{{UNIT}};',
						],
						'condition' => [
							'pagination_type' => ['bullets', 'fraction'],
							'pagination_pos' => ['bottom', 'bottom_outside'],
							'pagination_align' => ['left', 'right']
						]
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'size_units' => [ 'px', '%', 'em', 'rem', 'vw', 'vh', 'custom' ],
						'selectors' => [
							'{{WRAPPER}} .slider_container.slider_pagination_pos_bottom .slider_pagination_wrap.swiper-pagination-bullets .swiper-pagination-bullet' => 'margin: 0 calc( {{SIZE}}{{UNIT}} / 2 );',
							'{{WRAPPER}} .slider_container.slider_pagination_pos_left .slider_pagination_wrap.swiper-pagination-bullets .swiper-pagination-bullet' => 'margin: calc( {{SIZE}}{{UNIT}} / 2 ) 0;',
							'{{WRAPPER}} .slider_container.slider_pagination_pos_right .slider_pagination_wrap.swiper-pagination-bullets .swiper-pagination-bullet' => 'margin: calc( {{SIZE}}{{UNIT}} / 2 ) 0;',
							'{{WRAPPER}} .slider_container ~ .slider_pagination_wrap.swiper-pagination-bullets .swiper-pagination-bullet' => 'margin: 0 calc( {{SIZE}}{{UNIT}} / 2 );',
						],
					]
				);
