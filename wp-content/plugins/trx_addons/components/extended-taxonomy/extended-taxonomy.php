		...
		if ( trx_addons_extended_taxonomy_enable() ) {
			...
			if ( is_array( $tax_list ) ) {
				foreach ( $tax_list as $tax_name ) {
					...
					add_filter( "manage_{$tax_name}_custom_column",	'trx_addons_extended_taxonomy_fill_custom_column', 9, 3 );
				}
			}
		}
	}
...
if ( ! function_exists( 'trx_addons_extended_taxonomy_fill_custom_column' ) ) {
	// Handler of the add_filter( "manage_{$tax_name}_custom_column", 'trx_addons_extended_taxonomy_fill_custom_column', 9, 3);
