...
if (!function_exists('trx_addons_cpt_properties_taxonomy_neighborhood_fill_custom_column')) {
	add_filter('manage_'.TRX_ADDONS_CPT_PROPERTIES_TAXONOMY_NEIGHBORHOOD.'_custom_column',	'trx_addons_cpt_properties_taxonomy_neighborhood_fill_custom_column', 9, 3);
