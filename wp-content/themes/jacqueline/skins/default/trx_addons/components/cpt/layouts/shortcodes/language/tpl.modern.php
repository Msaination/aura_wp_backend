...
?><div<?php if (!empty($args['id'])) echo ' id="' . esc_attr($args['id']) . '"'; 
	?> class="sc_layouts_language sc_layouts_menu sc_layouts_menu_modern sc_layouts_menu_no_collapse<?php
	...
	$languages = trx_addons_exists_wpml() && function_exists('icl_get_languages')
					...
					: array(
							'en' => array(
								...
								'translated_name' => __( 'English', 'jacqueline' ),
								'url' => '#'
								),
							'de' => array(
								'active' => false,
								...
								'translated_name' => __( 'Deutsch', 'jacqueline' ),
								'url' => '#'
								),
							'es' => array(
								'active' => false,
								...
								'translated_name' => __( 'Español', 'jacqueline' ),
								'url' => '#'
								),
							);
