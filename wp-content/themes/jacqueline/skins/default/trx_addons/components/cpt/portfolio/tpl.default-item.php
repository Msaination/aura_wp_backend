		...
		data-details="<?php
			echo esc_attr( '<div class="post_details">'
								...
								. '<div class="post_description">'
									. $details
									. ( empty( $jacqueline_template_args['hide_excerpt'] )
										? '<div class="post_description_content">' . get_the_excerpt() . '</div>'
										: ''
										)
									. '<a href="' . esc_url( $link ) . '" class="theme_button post_readmore"><span class="post_readmore_label">' . esc_html__( 'Learn more', 'jacqueline' ) . '</span></a>'
								. '</div>'
							. '</div>'
						);
		?>"
		...
		apply_filters(
			...
			array(
                ...
                'post_info'     => '<a href="' . esc_url( $link ) . '"></a>' . '<div class="post_info">'
                    . '<h5 class="post_title">'
                    . '<a href="' . esc_url( $link ) . '">' . jacqueline_strwords( esc_html( get_the_title() ), 10 ) . '</a>'
                    . '</h5>'
