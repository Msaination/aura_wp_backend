...
#><div id="{{ id }}" class="<# print( trx_addons_apply_filters('trx_addons_filter_sc_classes', 'sc_price sc_price_' + settings.type, settings ) ); #>">
	...
	_.each(settings.prices, function(item) {
		...
		#>><#
			...
			if (item.image.url != '') {
				#><div class="sc_price_item_image"><img src="{{ item.image.url }}" alt="<?php esc_attr_e('Icon', 'jacqueline'); ?>"></div><#
			} else {
				...
				if (icon != '') {
					...
					#><div class="sc_price_item_icon sc_price_item_icon_type_{{ item.icon_type }} {{ icon }}"
						...
						if (svg != '') {
							...
							#><img class="sc_icon_as_image" src="{{ img }}" alt="<?php esc_attr_e('Icon', 'jacqueline'); ?>"><#
						} else {
	...
	if( settings.type != 'metro' && settings.type != 'focus' && settings.type != 'light' ) {
				...
				#>"<#
						...
						#><div class="sc_price_item_inner"><#
							...
							#><div class="sc_price_item_image">
                                <img src="{{ item.image.url }}" alt="<?php esc_attr_e('Icon', 'jacqueline'); ?>"><#
                                if (item.price != '' && settings.type == 'metro' ) {
                                #><div class="sc_price_item_price"><#
                                    if (item.before_price!='') {
                                    #><span class="sc_price_item_price_before"><# print(trx_addons_parse_codes(item.before_price)); #></span><#
                                    }
						...
						#><div class="sc_price_item_info"><#
							...
							if ( settings.type != 'metro' && item.price != '' ) {
								#><div class="sc_price_item_price"><#
								if (item.before_price!='') {
								#><span class="sc_price_item_price_before"><# print(trx_addons_parse_codes(item.before_price)); #></span><#
								}
                            ...
                            if ( settings.type == 'metro' && item.price != '' && item.image.url == '') {
                                #><div class="sc_price_item_price"><#
                                    if (item.before_price!='') {
                                    #><span class="sc_price_item_price_before"><# print(trx_addons_parse_codes(item.before_price)); #></span><#
                                    }
