...
jQuery( document ).on(
	'action.init_hidden_elements', function(e, cont) {
		...
		if (JACQUELINE_STORAGE['button_hover'] && JACQUELINE_STORAGE['button_hover'] != 'default') {
			jQuery(
				// Tag 'button'
				...
				// Theme tabs
				+ '.jacqueline_tabs .jacqueline_tabs_titles li a:not([class*="sc_button_hover_"]),'
				// More link
			...
			).addClass( 'sc_button_hover_just_init sc_button_hover_' + JACQUELINE_STORAGE['button_hover'] );

			// Add button's hover class if not based on :before or :after elements (like 'sc_button_hover_arrow')
			if (JACQUELINE_STORAGE['button_hover'] != 'arrow') {
				jQuery(
					// Form buttons
			...
			jQuery(
				...
				// Theme tabs
				+ '.jacqueline_tabs .jacqueline_tabs_titles li a:not([class*="sc_button_hover_style_"]),'
				// Tag cloud
			...
			).removeClass( 'sc_button_hover_' + JACQUELINE_STORAGE['button_hover'] );
        ...
        jQuery(
            ...
            + '.specific_hover .elementor-heading-title a:not(.underline_hover)'
