...
if ( ! function_exists( 'jacqueline_booked_get_css' ) ) {
	add_filter( 'jacqueline_filter_get_css', 'jacqueline_booked_get_css', 10, 2 );
	function jacqueline_booked_get_css( $css, $args ) {
