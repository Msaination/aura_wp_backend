...
if ( ! function_exists( 'jacqueline_trx_addons_get_css' ) ) {
	add_filter( 'jacqueline_filter_get_css', 'jacqueline_trx_addons_get_css', 10, 2 );
	function jacqueline_trx_addons_get_css( $css, $args ) {
...
.sc_icompare_default .sc_icompare_text_before,
.sc_icompare_default .sc_icompare_text_after,
