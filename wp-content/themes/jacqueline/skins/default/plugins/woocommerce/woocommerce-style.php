...
if ( ! function_exists( 'jacqueline_woocommerce_get_css' ) ) {
	add_filter( 'jacqueline_filter_get_css', 'jacqueline_woocommerce_get_css', 10, 2 );
	function jacqueline_woocommerce_get_css( $css, $args ) {
...
$fdir = jacqueline_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
