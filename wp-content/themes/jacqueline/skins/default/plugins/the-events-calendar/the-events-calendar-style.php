...
if ( ! function_exists( 'jacqueline_tribe_events_get_css' ) ) {
	add_filter( 'jacqueline_filter_get_css', 'jacqueline_tribe_events_get_css', 10, 2 );
	function jacqueline_tribe_events_get_css( $css, $args ) {
