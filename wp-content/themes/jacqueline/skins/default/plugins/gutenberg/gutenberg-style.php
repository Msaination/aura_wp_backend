...
if ( ! function_exists( 'jacqueline_gutenberg_get_css' ) ) {
	add_filter( 'jacqueline_filter_get_css', 'jacqueline_gutenberg_get_css', 10, 2 );
	function jacqueline_gutenberg_get_css( $css, $args ) {
