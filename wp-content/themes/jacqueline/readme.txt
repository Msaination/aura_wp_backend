== Jacqueline ==
Version: 2.24.0
Copyright: 2026, ThemeREX
WordPress version: required at least 5.0, tested up to 6.9
...
Please install and activate it before starting to use the theme Jacqueline.
...
Theme documentation is available on https://jacqueline.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Jacqueline is Fontello.
